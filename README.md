...
Este recurso está dirigido a docentes, familias, estudiantes, profesionales de apoyo, equipos de educación especial y comunidad educativa interesada en contar con materiales digitales accesibles para fortalecer experiencias de aprendizaje inclusivas.

## Alcance pedagógico

Los juegos incluidos o proyectados en este repositorio tienen carácter complementario. Su uso debe adaptarse a la edad, características, necesidades de apoyo, ritmo de aprendizaje y contexto de cada estudiante.

Las actividades no sustituyen una evaluación psicopedagógica, una sesión terapéutica, una planificación curricular ni el acompañamiento de profesionales especializados. Se recomienda emplearlas como apoyo dentro de una propuesta educativa más amplia.

## Funciones previstas

- Organización de juegos educativos por categorías.
- Actividades visuales e interactivas de uso simple.
- Recursos adaptables para diferentes ritmos de aprendizaje.
- Posibilidad de integrar instrucciones breves para docentes y familias.
- Diseño compatible con computadora, tablet y celular.
- Ampliación progresiva de materiales y dinámicas.
...
- Definición de categorías de juegos.
- Incorporación de actividades interactivas iniciales.
- Elaboración de instrucciones para docentes y familias.
- Revisión de accesibilidad visual y funcional.
- Validación pedagógica del uso de los recursos.
- Organización de evidencias y materiales complementarios.
